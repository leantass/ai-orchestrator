...
try {
  ...
  const planningA = adaptSemanticPlansToPlanning({ sourcePlanning, businessUnderstanding, contentPlan: contentA, experiencePlan: experienceA })
  const planningB = adaptSemanticPlansToPlanning({ sourcePlanning, businessUnderstanding, contentPlan: contentA, experiencePlan: experienceB })
  const planningC = adaptSemanticPlansToPlanning({ sourcePlanning, businessUnderstanding, contentPlan: contentB, experiencePlan: experienceA })
