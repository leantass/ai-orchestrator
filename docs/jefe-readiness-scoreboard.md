...
- Cerrada: apertura honesta de MEMORIA, estado operativo local de Context Hub, observabilidad minima del ultimo evento emitido y panel mas estable para automatizacion.
