...
contextBridge.exposeInMainWorld('jefeProjectBridge', {
  ...
  restoreVersion: (projectId, sourceVersionId) => ipcRenderer.invoke('jefe-projects:restore', { projectId, sourceVersionId }),
  prepareLocalDelivery: (projectId, versionId) => ipcRenderer.invoke('jefe-projects:prepare-local-delivery', { projectId, versionId }),
  getPreview: (projectId, versionId) => ipcRenderer.invoke('jefe-projects:preview', { projectId, versionId }),
